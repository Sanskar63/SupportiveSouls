    ...
    return (
        <div className="h-0 overflow-visible flex items-center justify-center">
            <nav className="w-[80%] h-[9vh] md:h-[12vh] px-[15%] md:px-[10%] bg-purple-mid  rounded-full flex items-center justify-center fixed top-[2%] z-50">
                ...
                {/* <Link href="/Events/add" className="whitespace-nowrap m-[5%] text-xs md:text-sm lg:text-xl text-white">Add Events</Link> */}
                ...
                {/* <Link href="/Events/rm" className="whitespace-nowrap m-[5%] text-xs md:text-sm lg:text-xl text-white">Remove Events</Link> */}
